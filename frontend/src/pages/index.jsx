  ...
  return (
    <Container maxW="container.md" py={5}>
      ...
      <Text fontSize="lg" lineHeight="tall">
        Welcome to VolunTier, where we aim to promote social connectivity and empathy by offering a service that helps volunteers as well as the local communities around the World.
